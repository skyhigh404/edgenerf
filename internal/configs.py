...
class Config:
  ...
  check_grad_for_nans: bool = True  # Whether to check grad or NaNs.
...
def define_common_flags():
  ...
  flags.DEFINE_string('checkpoint_dir', "out/", 'Gin config files.')
  flags.DEFINE_string('postfix', "_debug", 'Gin config files.')
  flags.DEFINE_string('dataset_id', "fern", 'Gin config files.')
